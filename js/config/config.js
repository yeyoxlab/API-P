prot_api.config(function($routeProvider,$translateProvider,$locationProvider){
	...
	.otherwise({ reditrectTo : "/" });
	 ...
	 $translateProvider.translations('en', {
		...
		'LOGIN_REQAU' : '¿REQUIERE AUTHENTICATION?',
		...
		//Meters
			...
			'METERS_CINCO' : 'REQUIRE AUTHENTICATION?' ,
			'METERS_SEIS' : 'YES' ,
	...
	$translateProvider.translations('es', {
		...
		'METERS_II_UNO' : 'INFORMACI\u00D3N DEL MEDIDOR',
		'METERS_II_DOS' : 'INFO_METER es aplicable para todo tipo de medidores inteligentes' ,
		...
		'METERS_III_NUEVE' : 'ESTADO DEL MEDIDOR',
		'METERS_IV' : 'STATUS_METER es aplicable para todos los tipos de medidores inteligentes',
