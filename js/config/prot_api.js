...
var prot_api = angular.module("prot_api",['ngResource','pascalprecht.translate']);
...
prot_api.config(['$translateProvider', function($translateProvider) {
	$translateProvider.
	translationsEnglish('en',translationsEnglish)
